...
describe('Extension unit tests', () => {
    ...
    it("activate - add subscriptions", () => {
        ...
        commandsMock.expects("registerCommand").withExactArgs("extension.mtaBuildCommand", mtaBuildCommand);
        commandsMock.expects("registerCommand").withExactArgs("extension.mtarDeployCommand", mtarDeployCommand);
