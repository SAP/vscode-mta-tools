...
export const messages = {
  ...
  SET_ORG_SPACE_VIA_CLI:
    "You must set Organization and Space in Cloud Foundry using the Cloud Foundry CLI to deploy your MTA archive. Go to https://github.com/cloudfoundry/cli to install the CLI and try again",
  INSTALL_MBT:
